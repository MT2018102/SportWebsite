...
import com.test.product.convertor.StringToEnumConverter;
import com.test.product.interceptors.LoggingInterceptors;
...
@Configuration
@ComponentScan(basePackages = "com.test.product")
public class ApplicationConfig extends WebMvcConfigurationSupport {
    ...
    // this is for custom converter used to convert String to Gender TYpe
    @Override
    ...
    public AsyncTaskExecutor mvcTaskExecutor(){
        ...
        threadPoolTaskExecutor.setThreadNamePrefix("sporty-thread-");
   ...
   /* @Bean
    ...
    @Bean
    public ThemeResolver theThemeResolver(){
